Feature: Object Dispatch Proxy

@UnitTest
Scenario: ObjectDispatchProxy - UT-01 - Should return a value when calling a function through the object dispatch proxy
...
@UnitTest
Scenario: ObjectDispatchProxy - UT-02 - Should allow usage of return, in, ref and out parameters when calling a function through the object dispatch proxy
...
@UnitTest
Scenario: ObjectDispatchProxy - UT-03 - Should allow usage of in, ref and out parameters when calling a method through the object dispatch proxy
